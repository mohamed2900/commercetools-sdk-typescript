...
/**
 *	The data representation for a price to be imported that is persisted as an embedded [Price](ctp:api:type:Price) in the Project.
 *
 */
export interface PriceImport extends ImportResource {
  ...
  /**
   *	The Reference to the [CustomerGroup](/../api/projects/customerGroups#customergroup) with which the embedded [Price](ctp:api:type:Price) is associated.
  ...
  /**
   *	The Reference to the [Channel](/../api/projects/channels#channel) with which the embedded [Price](ctp:api:type:Price) is associated.
  ...
  /**
   *	Only the embedded [Price](ctp:api:type:Price) updates will be published to `staged` and `current` projection.
   *
   *
   */
  ...
  /**
   *	The ProductVariant in which this embedded [Price](ctp:api:type:Price) is contained.
   *	The Reference to the [ProductVariant](/../api/projects/products#productvariant) with which the embedded [Price](ctp:api:type:Price) is associated.
  ...
  /**
   *	The Product in which the Product Variant containing this embedded [Price](ctp:api:type:Price) is contained. Maps to `ProductVariant.product`.
   *	The Reference to the [Product](/../api/projects/products#product) with which the embedded [Price](ctp:api:type:Price) is associated.
