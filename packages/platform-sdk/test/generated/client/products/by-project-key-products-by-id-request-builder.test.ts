...
export function getRequestsWithMethodParameters(): RequestWithMethod[] {
  return [
    ...
    {
      method: 'delete',
      uri: '/test_projectKey/products/test_ID?priceCurrency=priceCurrency&version=6',
      request: apiRoot
        .withProjectKey({ projectKey: 'test_projectKey' })
        .products()
        .withId({ ID: 'test_ID' })
    ...
    {
      method: 'delete',
      uri: '/test_projectKey/products/test_ID?priceCountry=priceCountry&version=6',
      request: apiRoot
        .withProjectKey({ projectKey: 'test_projectKey' })
        .products()
        .withId({ ID: 'test_ID' })
    ...
    {
      method: 'delete',
      uri: '/test_projectKey/products/test_ID?priceCustomerGroup=priceCustomerGroup&version=6',
      request: apiRoot
        .withProjectKey({ projectKey: 'test_projectKey' })
        .products()
        .withId({ ID: 'test_ID' })
    ...
    {
      method: 'delete',
      uri: '/test_projectKey/products/test_ID?priceChannel=priceChannel&version=6',
      request: apiRoot
        .withProjectKey({ projectKey: 'test_projectKey' })
        .products()
        .withId({ ID: 'test_ID' })
    ...
    {
      method: 'delete',
      uri: '/test_projectKey/products/test_ID?localeProjection=localeProjection&version=6',
      request: apiRoot
        .withProjectKey({ projectKey: 'test_projectKey' })
        .products()
        .withId({ ID: 'test_ID' })
    ...
    {
      method: 'delete',
      uri: '/test_projectKey/products/test_ID?storeProjection=storeProjection&version=6',
      request: apiRoot
        .withProjectKey({ projectKey: 'test_projectKey' })
        .products()
        .withId({ ID: 'test_ID' })
