...
export class ByProjectKeyRequestBuilder {
  ...
  /**
   *	Products are sellable goods in a commercetools Project. This document explains design concepts of Products and how to create, read, update, and delete them.
   *
   */
