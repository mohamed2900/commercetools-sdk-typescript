...
export interface AssociateRole extends BaseResource {
  ...
  readonly key: string
  /**
   *	Whether the AssociateRole can be assigned to an Associate by a [buyer](/../api/associates-overview#sellers-and-buyers). If false, the AssociateRole can only be assigned using the [general endpoint](/../api/associates-overview#the-general-endpoints).
   *
   *
   */
...
/**
 *	Permissions related to [Business Units](ctp:api:type:BusinessUnit).
 *
 */
export type BusinessUnitPermission =
  ...
  | string
/**
 *	Permissions related to [B2B Carts](ctp:api:type:Cart).
 *
 */
export type CartPermission =
  | 'CreateMyCarts'
  | 'CreateOthersCarts'
  | 'DeleteMyCarts'
  | 'DeleteOthersCarts'
...
export type OrderPermission =
  ...
  | string
/**
 *	Permissions over [Business Units](ctp:api:type:BusinessUnit), [Carts](ctp:api:type:Cart), [Orders](ctp:api:type:Order), [Quotes](ctp:api:type:Quote) and [QuoteRequests](ctp:api:type:QuoteRequest) assignable to an Associate Role.
 *
 */
...
export type QuotePermission =
  ...
  | string
/**
 *	Permissions related to [B2B Quote Requests](ctp:api:type:QuoteRequest).
 *
 */
export type QuoteRequestPermission =
  | 'CreateMyQuoteRequestsFromMyCarts'
  | 'CreateQuoteRequestsFromOthersCarts'
  | 'UpdateMyQuoteRequests'
  | 'UpdateOthersQuoteRequests'
...
/**
 *	Updating the name of an [AssociateRole](ctp:api:type:AssociateRole) generates an [AssociateRoleNameChanged](ctp:api:type:AssociateRoleNameChangedMessage) Message.
 *
 */
